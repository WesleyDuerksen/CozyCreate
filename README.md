...
In active development. Phases 1–5 complete (Create core, Create addons, decoration & ambience, adventure & world, QoL & food). Phase 6 — multiplayer hardening (server config tuning, final mrpack export) — in progress.
