...
- [Config source of truth is server/content/config/](project_config_source_of_truth.md) — Root config/ is gitignored and regenerated by export.sh; all mod config goes in server/content/config/; Patchouli books are an exception (see below)
