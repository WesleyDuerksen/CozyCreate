...
- [Commit workflow — validate first, capture configs, check gitignore](feedback_commit_workflow.md) — Required steps before every commit: validate.sh, git status server/config, .gitignore and .packwizignore checks
